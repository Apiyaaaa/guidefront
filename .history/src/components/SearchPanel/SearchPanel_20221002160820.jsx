...
export default function SearchPanel(props) {
    const { data, setData, origData, getArticle,   const recommend = [{article_id:1, title:'母猪上树'},{article_id:2, title:'公猪上树'}]
 } = props; //布局使用的文章数据，未排序的数据
    ...
    return (
        <div className={styles.searchPanel}>
            ...
            {/*Todo差个广告component*/}
            <div className={styles.ad}><RecommendCard props={RecommendCard}></RecommendCard></div>
        </div>
    )
}